...
function gameOver() {
  ...
  countdown.innerHTML = "Фініш";
  clearQuestion();
  showResults();
  startButton.innerText = "Почати знову";
...
function displayScores() {
  ...
  scoreArea.innerHTML = `<h2>Набрані бали</h2><ul id="highScoresList"></ul><button id="clearScores" class="btn" onclick="clearScores()">Очистити бали</button>`;
...
function clearScores() {
  highScores = [];
  highScoresList.innerHTML = "<h3>Результати очищено</h3>";
